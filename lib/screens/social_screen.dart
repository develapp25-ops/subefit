...
// Esta pantalla ahora funciona como el Hub Social, mostrando el feed y sugerencias.
class SocialScreen extends StatefulWidget {
  final void Function(String)? onNavigate;
  const SocialScreen({Key? key, this.onNavigate}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // backgroundColor: Colors.white, // Eliminado para usar el del tema
        elevation: 1,
        title: const Text('Comunidad', style: TextStyle(color: Colors.black)),
        centerTitle: true,
        actions: [
          IconButton(
